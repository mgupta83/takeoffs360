            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="mt-3 flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a
                    href={`mailto:${email}?subject=${encodeURIComponent("Inquiry from Takeoffs360")}&body=${encodeURIComponent("Hello,\n\nI would like to discuss my project. Please provide availability and next steps.\n\nThanks,\n")}`}
                    onClick={() => setOpen(false)}
                    className="rounded bg-slate-100 px-3 py-1 text-sm text-slate-800 hover:bg-slate-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400"
                  >
                    Send Email
